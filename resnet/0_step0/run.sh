...
#python3 ./multiproc.py --nproc_per_node 8 ./train.py --resume imagenet_fp.pth.tar --data=/home/LargeData/Large/ImageNet --dataset=imagenet --batch_size=64 --learning_rate=1e-3 --epochs=90 --arch resnet18 --qa=l3 --qw=l3 --save=imagenet_r18_c64_adam_la3lw3
python3 train.py --resume imagenet_a2w2.pth.tar --data=~/data/ImageNet --dataset=imagenet --batch_size=256 --learning_rate=1e-3 --epochs=90 --arch resnet18 --qa=fp --qw=m2 -j 32 --save=model