...
python3 train.py --resume imagenet_fp.pth.tar --data=~/data/ImageNet --dataset=imagenet --batch_size=256 --learning_rate=1e-3 --epochs=90 --arch resnet18 --qa=e2 --qw=fp -j 32 --save=model