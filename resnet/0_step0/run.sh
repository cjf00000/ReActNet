...
python3 train.py --resume cifar100_64_sa2.pth.tar --batch_size=128 --project=bnn-cifar-new --dataset=cifar100 --learning_rate 1e-3 --save=cifar100_fp18_c64_a2_4x_mixup_nowd --mixup=1 --weight_decay=0 --arch resnet18 --channel 64 --qa=fp --qw=a2 --data=~/data --epochs 90
