...
python3 train.py --resume imagenet_fp.pth.tar --data=~/data/ImageNet --dataset=imagenet --batch_size=256 --learning_rate=1e-3 --epochs=90 --arch resnet18 --qa=fp --qw=a2 -j 32 --save=model