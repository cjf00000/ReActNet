...
python3 train.py --batch_size=128 --dataset=cifar100 --learning_rate 0.1 --save=cifar100_fp18_c64_sgd_distill_wd5e-4_qa1_noscale --weight_decay=5e-4 --teacher=resnet34 --arch resnet18 --channel 64 --qa=q1 --data=~/data