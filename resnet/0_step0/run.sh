...
python3 ./multiproc.py --nproc_per_node 7 ./train.py --resume imagenet_sa2.pth.tar --data=/raid/data/LargeData/Large/ImageNet --dataset=imagenet --batch_size=73 --learning_rate=1e-3 --epochs=90 --arch resnet18 --qa=e2 --qw=fp -j 8 --save=imagenet_r18_c64_adam_e2
