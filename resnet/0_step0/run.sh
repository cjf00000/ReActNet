...
#python3 train.py --resume cifar100_64_fp.pth.tar --batch_size=128 --project=bnn-cifar-new --dataset=cifar100 --learning_rate 1e-3 --save=cifar100_fp18_c64_la2_mixup_nowd --mixup=1 --weight_decay=0 --arch resnet18 --channel 64 --qa=l2 --qw=fp --data=~/data --epochs 90
...
python3 ./multiproc.py --nproc_per_node 8 ./train.py --resume imagenet_fp.pth.tar --data=/raid/data/LargeData/Large/ImageNet --dataset=imagenet --batch_size=64 --warmup 4 --learning_rate=1e-4 --epochs=90 --arch resnet18 --qa=e2 --qw=fp -j 8 --save=tmp
