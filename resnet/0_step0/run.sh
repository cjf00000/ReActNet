...
python3 train.py --resume cifar100_64_fp.pth.tar --batch_size=128 --dataset=cifar100 --learning_rate 1e-3 --save=cifar100_fp18_c64_la1lw1 --weight_decay=5e-4 --arch resnet18 --channel 64 --qa=l1 --qw=l1 --data=~/data --epochs 90
